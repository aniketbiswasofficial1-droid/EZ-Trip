...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background relative z-10">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 animate-fade-in">
              ...
              <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold tracking-tight leading-[1.1]">
                Split expenses,
                <br />
      ...
      <section className="py-24 px-4 sm:px-6 bg-gradient-to-br from-primary/10 via-background to-background">
        <div className="max-w-7xl mx-auto">
